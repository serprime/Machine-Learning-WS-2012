...
After the first run with the Simple Naive Bayes algorithm we gain the result shown in table \ref{tab:adult:bayes:1d} and a confusion matrix \ref{tab:adult:bayes:1c}.
