...
\todo[inline]{Compare results with/without preprocessing}

\subsection{Decision Tree}
\todo[inline]{robert: do you want to keep this section? on the one hand it shows what happens if we run a desicion tree with attributes on which the the prediction attribute depends, but on the other hand we know we should not do that. please decide. i'm ok with both (philipp)}
%------------------------------------------------
