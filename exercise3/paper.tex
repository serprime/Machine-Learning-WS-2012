...
\item
A truncation of the iris data set, with a removed column to fit the data set to 3 dimensions
\end{enumerate}
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{Skin_predicted_k5}
\caption{The 'Skin-NonSkin' Data Set, colored by the predicted class attribute}
...
\caption{The 'Skin-NonSkin' Data Set, colored by correct or misclassified instance}
